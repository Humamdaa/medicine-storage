...
ELSE categories.name_en END as category_name"),
            ...
            ->latest('medicines.created_at')
            ->get();

        return $medicines;
    }

    public function getTopMedicins()
    {
        $medicines =$medicines = Medicine::where('available', 1)
            ->orderBy('popularity', 'DESC') // Add this line to prioritize popularity 10 over 5
            ->take(7)
            ->get();
        return $medicines;
    }
