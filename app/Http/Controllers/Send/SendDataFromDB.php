...
// replace the empty values with a default value.
        ...
        return redirect()->route('home')
            ->with('sevenMedicines', $sevenMedicines)
            ->with('top', $top)
            ->with('user', $values);
        //        return response()->json([
//            'sevenMedicines' => $sevenMedicines,
//            'user' => $values // contains token in header,and body, id, email of user
//        ]);
...
//        $orders = [];
        ...
        if ($yourOrders != null && $yourOrders != '[]') {
            ...
            echo "\n";
            return response()->json(['orders'=>$orders,'yourOrders'=> $yourOrders,
                'nameOfMedicines'=> $namesOfMedicines]);//$namesOfMedicines
        }
